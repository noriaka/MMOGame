...
public class DBMgr {
    ...
    public void Init() {
        conn = new MySqlConnection("server=localhost;User Id = root;password=123;Database=darkgod;Charset = utf8");
        conn.Open();
    ...
    private int InsertNewAcctData(string acct, string pass, PlayerData pd) {
        ...
        try {
            ...
            MySqlCommand cmd = new MySqlCommand(
                ...
                "guideid=@guideid,strong=@strong,time=@time,task=@task,dugeon=@dugeon", conn);
            cmd.Parameters.AddWithValue("acct", acct);
            ...
            cmd.Parameters.AddWithValue("dugeon", pd.dugeon);
    ...
    public bool UpdatePlayerData(int id, PlayerData playerData) {
        try {
            ...
            "crystal=@crystal,hp=@hp,ad=@ad,ap=@ap,addef=@addef,apdef=@apdef,dodge=@dodge,pierce=@pierce,critical=@critical," +
            "guideid=@guideid,strong=@strong,time=@time,task=@task,dugeon=@dugeon where id =@id", conn);
            ...
            cmd.Parameters.AddWithValue("task", taskInfo);
            cmd.Parameters.AddWithValue("dugeon", playerData.dugeon);
