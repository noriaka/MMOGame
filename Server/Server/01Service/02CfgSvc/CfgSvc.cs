...
public class CfgSvc
{
    ...
    private void InitGuideCfg()
    {
        ...
        doc.Load(@"F:\ProjectFileFolder\UnityProject\UnityProject01\ResDarkGod\第4章\工程文件\DarkGod\Client\Assets\Resources\ResCfgs\guide.xml");
    ...
    {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"F:\ProjectFileFolder\UnityProject\DarkGod\Client\Assets\Resources\ResCfgs\taskreward.xml");
    ...
    {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"F:\ProjectFileFolder\UnityProject\DarkGod\Client\Assets\Resources\ResCfgs\map.xml");
